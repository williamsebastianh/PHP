    ...
    <?php
                ...
                if($result) {
                    while($row=mysqli_fetch_assoc($result)) {
                        ...
                        <div class="cards p-2">
                          <img class="card-img-top" style="height: 200px; "src='.$foto.' alt="">
                          <div class="card-body">
                            <div class="d-flex justify-content-between">
                              <h5 class="card-title">'.$name.'</h5>
                            </div>
                            <div class="d-flex justify-content-between">
                              <a href="DaftarMuseum.php?daftarmuseum='.$name.'" class="bg-dark text-white text-center pl-2 pr-2 cart_btn">Lanjut</a>
                            </div>
                          </div>
                        </div>
                      </div>
